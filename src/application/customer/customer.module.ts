...
import { CustomerRepository } from "src/infrastructure/database/customer/repositories/customer-repository";
import { DataBaseModule } from "src/infrastructure/database/database.module";
import { customerProviders } from "src/infrastructure/database/customer/customer.provider";
